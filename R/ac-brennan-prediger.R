...
#' @title
#' Brennan-Prediger's agreement coefficient among multiple raters (2, 3, +) when
...
bp_3_dist <- function(distribution,
                      weights = "unweighted",
                      categ = NULL,
                      conf_lev = 0.95,
                      N = Inf,
